...
namespace HelloMaui.Pages
{
    ...
    public class DetailsPage_Csharp : BaseContentPage<DetailsViewModel>
    {
        ...
        public DetailsPage_Csharp(DetailsViewModel viewModel) : base(viewModel)
        {
            this.Bind(DetailsPage_Csharp.TitleProperty, getter: (DetailsViewModel viewModel) => viewModel.LibraryTitle);
